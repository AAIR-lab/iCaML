...
(:action a0
  ...
  :precondition (and (at_0-player0-cell_2_0)
        (clear-cell_3_0)
        (not (at_5-bottom_piece0-cell_2_0)
       )
       )
  ...
  :precondition (and (at_0-player0-cell_3_0)
       ...
       (:action a6
  :parameters (              )
  :precondition (and (at_1-key0-cell_3_2)
        (at_0-player0-cell_3_1)
       )
         :effect (and (not (at_1-key0-cell_3_2)
       )
        (clear-cell_3_2)
        (has_key-)
       ))
  ...
  :precondition (and (at_0-player0-cell_1_0)
        ...
        (has_key-)
         ...
         :effect (and (not (at_2-lock0-cell_1_1)
       )
        (clear-cell_1_1)
       ))
  ...
  :precondition (and (at_0-player0-cell_3_0)
        ...
        (not (player_has_0-)
         ...
         :effect (and (not (at_5-bottom_piece0-cell_4_0)
       )
        (player_has_2-)
        (clear-cell_4_0)
       ))
  ...
  :precondition (and (at_0-player0-cell_4_0)
        ...
        (is_goal-cell_1_2)
        (clear-cell_4_1)
        (not (at_5-bottom_piece0-cell_4_0)
       )
       )
  ...
  :precondition (and (at_0-player0-cell_4_2)
        ...
        (not (player_has_2-)
         ...
         :effect (and (not (at_4-middle_piece0-cell_4_3)
       )
        (player_has_1-)
        (clear-cell_4_3)
       ))
  ...
  :precondition (and (at_0-player0-cell_3_2)
        ...
        (not (player_has_2-)
         ...
         :effect (and (not (at_3-top_piece0-cell_3_3)
       )
        (clear-cell_3_3)
        (player_has_0-)
       ))
