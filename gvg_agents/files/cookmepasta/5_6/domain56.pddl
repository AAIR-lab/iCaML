...
(:predicates (leftOf-cell_0_0-cell_1_0)
             ...
             (at_3-raw_pasta0-cell_1_2)
             (clear-cell_3_1)
             (at_2-tomato0-cell_1_1)
             (clear-cell_3_4)
             (clear-cell_3_0)
             (clear-cell_5_3)
             (clear-cell_1_2)
             (at_7-pasta_done0-cell_3_1)
...
(:action a0
  ...
  :precondition (and (at_0-player0-cell_3_3)
        ...
        (not (at_4-boiling_water0-cell_2_3)
       )
        (not (clear-cell_1_3)
       )
        (at_0-player0-cell_2_3)
  ...
  :precondition (and (at_0-player0-cell_3_1)
        ...
        (not (at_1-tuna0-cell_2_1)
       )
        (not (at_2-tomato0-cell_1_1)
       )
        (at_6-sauce_in_place0-cell_1_1)
        (clear-cell_3_1)
        (at_0-player0-cell_2_1)
