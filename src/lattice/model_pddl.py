...
class State:
    ...
    #     if self.state == state2.state and self.objects == state2.objects:
    #         return True
    #     return False
...
class LatticeNode(object):
    ...
    @staticmethod
    def generate_preds_for_action(predicate, action, pred_type_mapping, action_parameters,grounded=False):
